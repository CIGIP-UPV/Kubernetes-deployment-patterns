{{- define "ros2-overlay-canonical.name" -}}
{{- default .Chart.Name .Values.nameOverride | trunc 63 | trimSuffix "-" -}}
{{- end }}

{{- define "ros2-overlay-canonical.fullname" -}}
{{- if .Values.fullnameOverride -}}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" -}}
{{- else -}}
{{- $name := include "ros2-overlay-canonical.name" . -}}
...
{{- define "ros2-overlay-canonical.labels" -}}
app.kubernetes.io/name: {{ include "ros2-overlay-canonical.name" . }}
...
*/}}
{{- define "ros2-overlay-canonical.overlayVersion" -}}
